...
# loads the files
for filename in os.listdir('data/midi_as_np/'):
    song_tracks = read_np_file('data/midi_as_np/' + filename)
    if 9 in song_tracks:
...
britney_track = read_np_file('data/midi_as_np/Britney_Spears_-_Baby_One_More_Time.npy')
